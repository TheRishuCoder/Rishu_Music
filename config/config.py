...
OWNERASS_ID = int(getenv("OWNER_ID", "1209978813"))
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/TheRishuCoder/Rishu_Music",
)
...
SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/GODCHEATTELEGRAM")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/GODCHEATFAMILY")
